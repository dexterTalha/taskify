...
// in taskify/test/integration/task_provider_integration_test.dart.
...
import 'package:taskify/domain/entities/task.dart' as _i4;
import 'package:taskify/domain/repositories/task_repository.dart' as _i2;
...
class MockTaskRepository extends _i1.Mock implements _i2.TaskRepository {
  ...
  @override
  _i3.Future<List<_i4.Task>> getTasksByPriority(int? priority) =>
      (super.noSuchMethod(
        Invocation.method(
          #getTasksByPriority,
          [priority],
  ...
  @override
  _i3.Future<int> getCompletedTasksCount() => (super.noSuchMethod(
        Invocation.method(
